            ...
            <div className="container topbar bg-primary d-none d-lg-block">
                <div className="d-flex justify-content-between">
                    <div className="top-info ps-2">
                        <small className="me-3"><i className="fas fa-map-marker-alt me-2 text-secondary"></i> <NavLink to="#" className="text-white">123 Street, New York</NavLink></small>
                        <small className="me-3"><i className="fas fa-envelope me-2 text-secondary"></i><NavLink to="#" className="text-white">Email@Example.com</NavLink></small>
                    </div>
                ...
                <nav className="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div className="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div className="navbar-nav mx-auto">
                            ...
                            <NavLink to="shop-detail.html" className="nav-item nav-link">Shop Detail</NavLink>
                            <div className="nav-item dropdown">
                                <NavLink to="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</NavLink>
                                <div className="dropdown-menu m-0 bg-secondary rounded-0">
                                    <NavLink to="cart.html" className="dropdown-item">Cart</NavLink>
                                    <NavLink to="chackout.html" className="dropdown-item">Chackout</NavLink>
                        ...
                        <div className="d-flex m-3 me-0">
                            ...
                            <NavLink to="#" className="position-relative me-4 my-auto">
